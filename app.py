...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.iconbitmap("CustomTkinter_logo_single.ico")
        # set grid layout 1x2
        ...
        self.frame_3_button = customtkinter.CTkButton(self.navigation_frame, corner_radius=0, height=40, border_spacing=10, text="CONTACT US",
                                                      fg_color="transparent", text_color=("gray10", "gray90"), hover_color=("gray70", "gray30"),
        ...
        self.analyze_upload_agn_btn.grid(row=10, column=0, pady=10, padx=20, sticky="nw")
        ...
        self.home_title_label = customtkinter.CTkLabel(
            self.third_frame, text="CONTACT US", font=customtkinter.CTkFont(size=25, weight="bold"))
        self.home_title_label.grid(
            row=0, column=0, pady=50)
        self.home_description_label = customtkinter.CTkLabel(
            self.third_frame, text="TEAM PRAKALP\n JOYJIT DAS \n INDRANEEL SARKAR \n SHANTANU SAHA \n NIRVIK GHOSH")
    ...
    def analyze_btn(self):
        ...
        self.analyze_doc_label1.configure(
            text=str(fu.file_procees(file_path)))
